...
namespace ExpenseTrackerWeb.Models
{
    public class MobileServiceContext : DbContext
    {
        ...
        private const string ConnectionStringName =
                "Data Source=teknita.database.windows.net;Initial Catalog=expensetracker;Integrated Security=False;User ID=devops;Password=Mz@93254;Connect Timeout=0;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"
            ;
